...
import { createWishlist, fetchAllWishlists } from '@/store/action/wishlist';
import { fetchAllUsers } from '@/store/action/user';
import { fetchAllProducts } from '@/store/action/products';

export const AddWishlistModal: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
       ...
       const cartData = {
           ...
           try{
               const result = await dispatch(createWishlist({wishlistData: cartData})).unwrap();
