  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2">
    <div className="flex items-center justify-between">
      <Link to="/" className="flex items-center group w-30">
        {/* <h1 className="text-2xl font-bold text-black tracking-tight group-hover:text-blue-600 transition-colors">
          Deflux
        </h1> */}
        <div className="logo">
            <img src="/src/assets/logos/delogo.png" alt="" />
        </div>
      </Link>
      ...
      <div className="flex items-center gap-2">
        ...
        {user === null ? (
          <Button
            variant="ghost"
            className="hidden md:flex text-black hover:bg-gray-100 rounded-full"
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown
                size={16}
                className="hidden sm:block transition-transform duration-300 text-black"
              />
            </div>
            <div
        ...
        <Button
          variant="ghost"
          size="icon"
          className="md:hidden text-black hover:bg-gray-100 rounded-full"
          onClick={toggleMenu}
        >
    ...
    {isMenuOpen && (
      <div className="md:hidden overflow-y-auto right-[1px] w-[55%] fixed inset-0 top-[60px] bg-white text-black animate-slide-in-left border-t border-gray-300">
